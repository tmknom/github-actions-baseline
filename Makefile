...
#
.PHONY: build
build: build-prettier build-markdownlint build-yamllint build-jsonlint build-detect-secrets build-write-good build-proselint build-alex ## build all docker images
